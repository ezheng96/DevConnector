...
export const getProfiles = () => async (dispatch) => {
  //want to clear profiles state, because when we go into a single users profile, were going into the profile state with just that user?
  //Will prevent the flashing of the last users profile
  dispatch({
    type: CLEAR_PROFILE,
  });
  try {
